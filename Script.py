...
class script(object):
    START_TXT = """👋 𝑯𝒆𝒍𝒍𝒐 {},
𝒎𝒚 𝒏𝒂𝒎𝒆 𝒊𝒔 {},\n 𝑰𝒂𝒎 𝑨 𝑺𝒊𝒎𝒑𝒍𝒆 𝑨𝒖𝒕𝒐 𝑭𝒊𝒍𝒕𝒆𝒓 + 𝑴𝒐𝒗𝒊𝒆 𝑺𝒆𝒂𝒓𝒄𝒉 + 𝑴𝒂𝒏𝒖𝒂𝒍 𝑭𝒊𝒍𝒕𝒆𝒓 𝑩𝒐𝒕. 𝑰 𝑪𝒂𝒏 𝑷𝒓𝒐𝒗𝒊𝒅𝒆 𝑴𝒐𝒗𝒊𝒆𝒔 𝑰𝒏 𝑻𝒆𝒍𝒆𝒈𝒓𝒂𝒎 𝑮𝒓𝒐𝒖𝒑𝒔. 𝑰 𝑪𝒂𝒏 𝑨𝒍𝒔𝒐 𝑨𝒅𝒅 𝑭𝒊𝒍𝒕𝒆𝒓𝒔 𝑰𝒏 𝑻𝒆𝒍𝒆𝒈𝒓𝒂𝒎 𝑮𝒓𝒐𝒖𝒑𝒔.  𝑱𝒖𝒔𝒕 𝑨𝒅𝒅 𝑴𝒆 𝑻𝒐 𝒀𝒐𝒖𝒓 𝑮𝒓𝒐𝒖𝒑 𝑨𝒔 𝑨𝒅𝒎𝒊𝒏 𝑨𝒏𝒅 𝑬𝒏𝒋𝒐𝒚..."""
    HELP_TXT = """𝙷𝙴𝚈 {}
...
𝙲𝚁𝙴𝙳𝙸𝚃𝚂 ›› <a href=https://t.me/+yP9ckmsoGF1kNDNl><b>cinema club</b></a>"""
...
𝙲𝚁𝙴𝙳𝙸𝚃𝚂 :- <a href=https://t.me/dxfilter>suneesh DeeZuZza</a>"""
...
𝙲𝚁𝙴𝙳𝙸𝚃𝚂 :- <a href=https://t.me/+yP9ckmsoGF1kNDNl>cinema club</a>**"""
...
𝖬𝖺𝖽𝖾 𝖻𝗒 <a href=https://t.me/CINEMA_CLUB_ADMIN_ROBOT>Bᴏᴛ ᴏᴡɴᴇʀ</a>"""
